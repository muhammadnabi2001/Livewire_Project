                        ...
                        <table class="table table-bordered text-center">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <th>{{$meal->price}}</th>
                                    <th><img src="{{ asset('storage/' . $meal->img) }}" alt="Meal Image" width="100px"
                                            height="100px"></th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="mb-3">
                                            <input type="number" class="form-control" wire:model.blur="editprice">
                                            @error('editprice')
                                            <span class="text-danger d-block mt-1">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <td>
                                        <div class="mb-3">
                                            <input type="file" class="form-control" wire:model="editimg">
