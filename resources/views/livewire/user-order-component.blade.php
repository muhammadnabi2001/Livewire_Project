        ...
        <section class="content pb-3">
            <div class="container h-100">
                ...
                <div class="card card-row card-default">
                    ...
                    <div class="card-body">
                        ...
                        <div class="card card-info card-outline">
                            ...
                            <div class="card-footer d-flex justify-content-end">
                                <button wire:click="qabul({{$t->id}})" class="btn btn-success btn-sm">
                                    <i class="fas fa-check"></i> Qabul qilish
                                </button>
                            </div>
                            @endif
                ...
                <div class="card card-row card-success">
                    <div class="card-header">
                        <h3 class="card-title">
                            Klientga yetkazilgan
                        </h3>
                    </div>
                    <div class="card-body">
                        @foreach($yetkazilgan as $y)
                        <div class="card card-info card-outline">
                            <div class="card-header">
                                <h5 class="card-title">{{$y->queue}}-Navbat</h5>
                                <div class="card-tools">
                                    <a wire:click="see({{$y->id}})" class="btn btn-tool">
                                        <i class="fas fa-pen"></i>
                                    </a>
                                </div>
                            </div>
                            ...
                            @if($licence == $y->id)
                            <div class="card-body">
                                @foreach($y->orderItems as $orderItem)
                                <div class="custom-control custom-checkbox">
                                    <input class="custom-control-input" type="checkbox"
                                        id="customCheckbox1{{$orderItem->id}}" disabled>
                                    <label for="customCheckbox1{{$orderItem->id}}" class="custom-control-label">
